...
def img_callback(data):
    ...
    yolov5_detection.run_detection(real_image, model, pub, 5)
    # print("Camera booted!")
...
def main():
    ...
    rospy.init_node('object_detection5')
    global pub 
    pub = rospy.Publisher('/uav5/found_bb8', Bool, queue_size=5)
    pub.publish(Bool(False))
    img_sub = rospy.Subscriber("/uav5/front_cam/camera/image", Image, img_callback)
    rospy.spin()
