...
def img_callback(data):
    ...
    yolov5_detection.run_detection(real_image, model, pub, 2)
    # print("Camera booted!")
    cv2.imshow("Raw Image 2", cv_image)
    cv2.waitKey(3)
    rate.sleep()

def main():
    print("Camera feed starting up.....")
    rospy.init_node('object_detection2')
    global pub 
    pub = rospy.Publisher('/uav2/found_bb8', Bool, queue_size=5)
