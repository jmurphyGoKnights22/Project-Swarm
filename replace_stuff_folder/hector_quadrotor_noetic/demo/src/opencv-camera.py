...
model = torch.hub.load('ultralytics/yolov5', 'custom', path= homedir + "/catkin_ws/src/hector_quadrotor_noetic/hector_quadrotor/hector_quadrotor_demo/launch/src/bestDoubleBoneless800.pt", force_reload=True)
model.to(device)
pub = None
